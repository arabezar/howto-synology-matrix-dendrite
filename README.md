...
Задайте папку проекта [matrix] (Enter - подтвердить):
...
Создайте в Container Manager проект matrix-dendrite, задайте путь /docker/matrix, запустите проект и продолжайте здесь... задайте имя пользователя-администратора [admin] (Enter - подтвердить):
